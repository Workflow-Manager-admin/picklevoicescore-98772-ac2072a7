/**
 * Top-level SpeechSynthesis mocks for test environment.
 * These are required for voice features to work in tests (Create React App compatible).
 */
console.log("[setupTests.js] Mocking window.speechSynthesis and getVoices (pre-import)");
if (typeof window !== "undefined") {
  ...
  console.log("[setupTests.js] speechSynthesis.getVoices:", typeof window.speechSynthesis.getVoices, window.speechSynthesis.getVoices());
}

// Pre-test environment setup (secondary): polyfills for test environment.
